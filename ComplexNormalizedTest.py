...
print(len(xs_normalized_change))
print(len(ys_normalized_change))

fig, axes = plt.subplots()
axes.scatter(xs_normalized_nochange,ys_normalized_nochange, label='mapping statement unchanged')
axes.scatter(xs_normalized_change,ys_normalized_change, label='mapping statement changed')
axes.legend()
plt.show()
