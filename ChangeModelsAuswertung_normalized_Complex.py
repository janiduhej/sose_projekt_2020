...
evaluate_data(train_values, train_labels, test_values, test_labels, 'normalized embeddings')
...
evaluate_data(train_values, train_labels, test_values, test_labels, 'normalized changes')
...
evaluate_data(train_values, train_labels, test_values, test_labels, 'normalized changes and embeddings')
